...
Object.defineProperties(obj, {
  ...
  setStart: {
    value: function () {
      console.log(
        "monkey A / monkey B / water / box tissue / bag tissue  (1,2,3) start"
      );
  ...
  setEnd: {
    value: function () {
      console.log(
        "monkey A / monkey B / water / box tissue / bag tissue  (1,2,3) end"
      );
  ...
  calc: {
    value: function () {
      ...
      if (moka_end - this.moka_morningTotal == moka_start - moka_end) {
        console.log(`\x1b[32m mok A amount ok!\x1b[0m`);
      } else {
        console.log(
      ...
      if (mokb_end - this.mokb_morningTotal == mokb_end - mokb_start) {
        console.log(`\x1b[32m mok B amount ok!\x1b[0m`);
      } else {
        console.log(
      ...
      console.log(`water endTotal = \x1b[31m${water_end}\x1b[0m`);

      if (water_end - this.water_morningTotal == water_end - water_start) {
        console.log(`\x1b[32m water amount ok!\x1b[0m`);
      } else {
        console.log(
      ...
      console.log(`box tissue endTotal = \x1b[31m${boxtis_end}\x1b[0m`);

      if (boxtis_end - this.boxtis_morningTotal == boxtis_end - boxtis_start) {
        console.log(`\x1b[32m box tissue amount ok!\x1b[0m`);
      } else {
        console.log(
      ...
      console.log(`bag tissue endTotal = \x1b[31m${bagtis_end}\x1b[0m`);

      if (bagtis_end - this.bagtis_morningTotal == bagtis_end - bagtis_start) {
        console.log(`\x1b[32m bag tissue amount ok!\x1b[0m`);
      } else {
        console.log(
  ...
  Total: {
    value: function () {
      let mokA_startTotal =
        this.moka_start1 + this.moka_start2 + this.moka_start3;
      let mokB_startTotal =
        this.mokb_start1 + this.mokb_start2 + this.mokb_start3;
      let water_startTotal =
        this.water_end1 + this.water_start2 + this.water_start3;
      let boxtis_startTotal =
        this.boxtis_start1 + this.boxtis_start2 + this.boxtis_start3;
      let bagtis_startTotal =
        this.bagtis_start1 + this.bagtis_start2 + this.bagtis_start3;

      let mokA_endTotal = this.moka_end1 + this.moka_end2 + this.moka_end3;
      let mokB_endTotal = this.mokb_end1 + this.mokb_end2 + this.mokb_end3;
      let water_endTotal = this.water_end1 + this.water_end2 + this.water_end3;
      let boxtis_endTotal =
        this.boxtis_end1 + this.boxtis_end2 + this.boxtis_end3;
      let bagtis_endTotal =
        this.bagtis_end1 + this.bagtis_end2 + this.bagtis_end3;
      return [
        mokA_endTotal,
        mokB_endTotal,
        water_endTotal,
